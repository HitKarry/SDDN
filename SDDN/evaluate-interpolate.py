...
data = np.load('result_interpolate.npz')
ilr_bilinear,ilr_bicubic,hr = torch.tensor(data['ilr_bilinear']),torch.tensor(data['ilr_bicubic']),torch.tensor(data['hr'])

print(ilr_bilinear.shape,ilr_bicubic.shape,hr.shape)
