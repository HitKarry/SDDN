...
class RCAN(nn.Module):
    def __init__(self, configs, conv=common.default_conv):
        ...
        n_resgroups = configs.n_resgroups
        ...
        # define head module
        modules_head = [conv(configs.n_colors, n_feats, kernel_size)]

        # define body module
        modules_body = [
            ResidualGroup(
                conv, n_feats, kernel_size, reduction, act=act, res_scale=configs.res_scale, n_resblocks=n_resblocks) \
        ...
        modules_tail = [
            ...
            conv(n_feats, configs.n_colors, kernel_size)]
