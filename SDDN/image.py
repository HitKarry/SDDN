...
data = np.load('result047168456.npz')
data_lr = np.load('../../data/lr_data_rh850_z500_t850_X8.npz')
lr = data_lr['data'][:5]
ilr2,sr2,hr2 = data['ilr'][:5],data['sr'][:5],data['hr'][:5] # (746, 3, 360, 720)
ilr,sr,hr = ilr2,sr2-hr2,hr2-hr2
...
for i in range(len(image_hr)):
    ...
    io.imsave('../../images/2sr_image_' + str(i) + '.jpg', util.img_as_ubyte(image_sr[i]))