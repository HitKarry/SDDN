...
class Trainer:
    def __init__(self, configs):
        ...
        torch.manual_seed(5)
        self.network = LapSRN().to(configs.device)
        ...
        self.L1_Charbonnier_loss = L1_Charbonnier_loss()
    ...
    def loss(self, y_pred, y_true, idx):
        mse = self.L1_Charbonnier_loss(y_pred, y_true)
        return mse
...
if __name__ == '__main__':
    ...
    model = LapSRN().to(configs.device)
    net = torch.load('checkpoint_0.054106105.chk')
